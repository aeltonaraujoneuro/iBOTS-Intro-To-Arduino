...
// [x] Fill in the boilerplate Arduino code
// [x Print the line "I'm ready!" to the serial port when the device starts.
// [x] Print the line "Still Ready..." every two seconds.
